...
//                'username' => 'andriyhoroz@gmail.com',
//                'password' => 'E=HaY8ry');
            $config = array('ssl' => 'tls', 'port' => 587, 'auth' => 'login', 'username' => 'andriyhoroz@gmail.com', 'password' => '');
            ...
            $mail->addTo('andriyhoroz@gmail.com', 'webmaster');
            ...
            try {
                ...
                Zend_Debug::dump($ex, '$ex while sending');
            }
